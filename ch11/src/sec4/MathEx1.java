...
public class MathEx1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("-6.8 => "+Math.round(-6.8));
		System.out.println("돗수분포에서 가장 큰 수 =>"+Math.max(8,7));
		System.out.println("돗수분포에서 가장 큰 수 =>"+Math.min(8,7));
		System.out.println("랜덤수 : "+(int) (Math.random()+1)); //0~1 아무 수나 무작위로 나타내는 수
		for(int i=1;i<=100;i++) {
