...
public class StringEx1 {
	public static void main(String[] args) {
		...
		System.out.println("협의 위치 : "+data.indexOf("협")); //특정 문자의 위치를 변환
		System.out.println("data의 글자수 : "+data.length()); //특정 문자열의 글자수 변환
		String a = data.replace("동협", "태균"); //특정 문자나 문자열의 치환
		System.out.println(a);
		String jumin = "120416-3412118";
		System.out.println("출생년도 : "+jumin.substring(0, 2)); //begin 이상 ~ end 미만
		System.out.print("성별 : ");
